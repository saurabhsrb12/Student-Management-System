	...
	public static void main(String[] args)throws IOException {
		...
		while(true)
		{
			...
			else if(c==4) 
			{
				...
				System.out.println("ENTER USER PHONE FOR UPDATE :");
				String phone=br.readLine();
				
				System.out.println("ENTER USER CITY UPDATE:");
				String city=br.readLine();
				
				Student st=new Student(name,phone,city);
				
				boolean answer=StudentDao.updateStudent(userId,st);
				
				if (answer) {
					System.out.print("STUDENT IS SUCCESFULLY UPDATED.......");
				}
				else {
					System.out.print("SOMETHING WENT WRONG.......TRY AGAIN");	
				}
